...
public class GUIFood extends javax.swing.JFrame {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        String name = txtName.getText();
        if (name.isEmpty()) {
            Messages.warningMessage("Ingrese un nombre", "Atencion");
            txtName.requestFocus();
            return;
        }
        ...
        invoker.execute();
        //La comida previa debe crearse en una nueva instancia
        Food componenteAuxiliar = findByIdCommand.getFood();
        Food previous = new Food(componenteAuxiliar.getId(), componenteAuxiliar.getName(), componenteAuxiliar.getType());

        //elimina la comida y guarda el previo
        deleteFood(food, previous);

        Messages.successMessage("Se ha modificado la comida", "Atencion");
        clearControls();
        initStateButtons();
        loadDataTable();
